...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Már 10. 11:30
...
CREATE TABLE `post` (
  ...
  `description` varchar(50) COLLATE utf8_hungarian_ci NOT NULL DEFAULT '',
...
INSERT INTO `post` (`post_id`, `uid`, `title`, `description`, `bookmark_count`, `comment_count`, `timestamp`, `visible`, `type`) VALUES
(1293, 2330, 'roka', 'a roka a kamerat nezi', 1, 7, '2022-02-03 08:26:29', 1, 'image/jpg'),
